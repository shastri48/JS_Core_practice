...
quoteText.textContent = quotes[0].quoteText;
author.textContent = quotes[0].quoteAuthor;
function randomQuotes(){
    randomNumber = Math.floor(Math.random() * 77);
    randomQuote = quotes[randomNumber].quoteText; 
    randomAuthor = quotes[randomNumber].quoteAuthor;
...
window.addEventListener("keydown", generateQuote);
